    ...
    <div class="container">
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4">
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm" data-tilt>
                    ...
                    <h5 class="card-title text-custom-primary">Listar Voluntarios <i class="fa fa-users"></i></h5>
                        ...
                        <a href="{{ route('voluntarios.index') }}" class="btn btn-outline-custom-primary stretched-link">Ver Voluntarios</a>
                    </div>
                </div>
            </div>
            ...
            <div class="col">
                <div class="card h-100 border-0 shadow-sm" data-tilt>
                    <div class="card-body">
                        <h5 class="card-title text-custom-primary">Listar Coordinadores <i class="fa fa-users"></i></h5>
                        <p class="card-text">Accede a la lista de coordinadores y gestiona su información.</p>
                        <a href="{{ route('coordinadores.index') }}" class="btn btn-outline-custom-primary stretched-link">Ver Coordinadores</a>
                    </div>
                </div>
            </div>
            @endif
